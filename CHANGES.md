...
All notable changes to the `qtype_buchungssatz` plugin are documented in this file.
...
- Course-level chart of accounts management (`manage_charts.php`, `edit_chart.php`) backed by `qtype_buchungssatz_charts` and `qtype_buchungssatz_accounts` tables.
